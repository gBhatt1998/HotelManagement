        ...
        this.actions$.pipe(
            ...
            mergeMap(() => {
                ...
                return this.roomTypeService.getRoomTypes().pipe(
                    ...
                    catchError(error => {
                        dialogRef.close();
                        this.dialogService.openError({ title: 'Load Failed', message: 'Failed to load room types.' });
        ...
        this.actions$.pipe(
            ...
            mergeMap(({ roomType }) => {
                ...
                return this.roomTypeService.addRoomType(roomType).pipe(
                    tap(() => dialogRef.close()),
                    map(newRoomType => {
                        this.dialogService.openSuccess({ title: 'Added', message: 'Room type added successfully' });
                        return RoomTypeActions.addRoomTypeSuccess({ roomType: newRoomType });
                    }),
                    catchError(error => {
                        dialogRef.close();
                        this.dialogService.openError({ title: 'Add Failed', message: 'Failed to add room type' });
        ...
        this.actions$.pipe(
            ...
            mergeMap(({ id, roomType }) => {
                ...
                return this.roomTypeService.updateRoomType(id, roomType).pipe(
                    tap(() => dialogRef.close()),
                    map(updatedRoomType => {
                        this.dialogService.openSuccess({ title: 'Updated', message: 'Room type updated successfully' });
                        return RoomTypeActions.updateRoomTypeSuccess({ roomType: updatedRoomType });
                    }),
                    catchError(error => {
                        dialogRef.close();
                        this.dialogService.openError({ title: 'Update Failed', message: 'Failed to update room type' });
        ...
        this.actions$.pipe(
            ...
            mergeMap(({ id }) => {
                ...
                return this.roomTypeService.deleteRoomType(id).pipe(
                    tap(() => dialogRef.close()),
                    map(() => {
                        this.dialogService.openSuccess({ title: 'Deleted', message: 'Room type deleted successfully' });
                        return RoomTypeActions.deleteRoomTypeSuccess({ id });
                    }),
                    catchError(error => {
                        dialogRef.close();
                        this.dialogService.openError({ title: 'Delete Failed', message: 'Failed to delete room type' });
